...
server = Popen(["node", "node_server/index.js"], stderr=subprocess.PIPE)
...
for index in range(rag+1):
    ...
    datajs = [data["verse"]["text_uthmani"], data["verse"]["translations"][1]['text'], data["verse"]["verse_key"], nameing]
